...
const revealElements = document.querySelectorAll(
    ".reveal, .section-heading, .service-card, .benefit-card, .destination-card, .step, .contact-card, .booking-info-card, .booking-form-card, .vehicle-visual, .vehicle-content, .service-cta, .experience-section, .how-section, .sightseeing-card"
);
